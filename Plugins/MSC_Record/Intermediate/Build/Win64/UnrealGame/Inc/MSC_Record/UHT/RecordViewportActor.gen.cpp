...
// End Cross Module References
	...
	struct Z_CompiledInDeferFile_FID_Users_Michel_Documents_Unreal_Projects_AM_VR_Plugins_MSC_Record_Source_MSC_Record_Public_RecordViewportActor_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Michel_Documents_Unreal_Projects_AM_VR_Plugins_MSC_Record_Source_MSC_Record_Public_RecordViewportActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ARecordViewportActor, ARecordViewportActor::StaticClass, TEXT("ARecordViewportActor"), &Z_Registration_Info_UClass_ARecordViewportActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ARecordViewportActor), 3329873050U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Michel_Documents_Unreal_Projects_AM_VR_Plugins_MSC_Record_Source_MSC_Record_Public_RecordViewportActor_h_376161243(TEXT("/Script/MSC_Record"),
		Z_CompiledInDeferFile_FID_Users_Michel_Documents_Unreal_Projects_AM_VR_Plugins_MSC_Record_Source_MSC_Record_Public_RecordViewportActor_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Michel_Documents_Unreal_Projects_AM_VR_Plugins_MSC_Record_Source_MSC_Record_Public_RecordViewportActor_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
