...
// End Cross Module References
	...
	UMSC_VideoCaptureProtocol::UMSC_VideoCaptureProtocol(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {}
	...
	UMSC_PreviewRecorder::UMSC_PreviewRecorder(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UMSC_PreviewRecorder);
	UMSC_PreviewRecorder::~UMSC_PreviewRecorder() {}
	struct Z_CompiledInDeferFile_FID_Users_Michel_Documents_Unreal_Projects_AM_VR_Plugins_MSC_Record_Source_MSC_Record_Public_MSC_VideoCaptureProtocol_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Michel_Documents_Unreal_Projects_AM_VR_Plugins_MSC_Record_Source_MSC_Record_Public_MSC_VideoCaptureProtocol_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Michel_Documents_Unreal_Projects_AM_VR_Plugins_MSC_Record_Source_MSC_Record_Public_MSC_VideoCaptureProtocol_h_3268244488(TEXT("/Script/MSC_Record"),
		Z_CompiledInDeferFile_FID_Users_Michel_Documents_Unreal_Projects_AM_VR_Plugins_MSC_Record_Source_MSC_Record_Public_MSC_VideoCaptureProtocol_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Michel_Documents_Unreal_Projects_AM_VR_Plugins_MSC_Record_Source_MSC_Record_Public_MSC_VideoCaptureProtocol_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
