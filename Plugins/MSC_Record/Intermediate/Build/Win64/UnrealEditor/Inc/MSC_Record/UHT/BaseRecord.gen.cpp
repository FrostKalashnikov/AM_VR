...
// End Cross Module References
	...
	static UEnum* ECaptureSourceType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ECaptureSourceType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_MSC_Record_ECaptureSourceType, (UObject*)Z_Construct_UPackage__Script_MSC_Record(), TEXT("ECaptureSourceType"));
		}
...
void FOnExportFinished_DelegateWrapper(const FMulticastScriptDelegate& OnExportFinished)
{
...
class UScriptStruct* FRecordingSettings::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RecordingSettings.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRecordingSettings, (UObject*)Z_Construct_UPackage__Script_MSC_Record(), TEXT("RecordingSettings"));
	}
...
template<> MSC_RECORD_API UScriptStruct* StaticStruct<FRecordingSettings>()
{
	...
	struct Z_CompiledInDeferFile_FID_Users_Michel_Documents_Unreal_Projects_AM_VR_Plugins_MSC_Record_Source_MSC_Record_Public_BaseRecord_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Michel_Documents_Unreal_Projects_AM_VR_Plugins_MSC_Record_Source_MSC_Record_Public_BaseRecord_h_Statics::EnumInfo[] = {
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Michel_Documents_Unreal_Projects_AM_VR_Plugins_MSC_Record_Source_MSC_Record_Public_BaseRecord_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Michel_Documents_Unreal_Projects_AM_VR_Plugins_MSC_Record_Source_MSC_Record_Public_BaseRecord_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ABaseRecord, ABaseRecord::StaticClass, TEXT("ABaseRecord"), &Z_Registration_Info_UClass_ABaseRecord, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ABaseRecord), 3789953226U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Michel_Documents_Unreal_Projects_AM_VR_Plugins_MSC_Record_Source_MSC_Record_Public_BaseRecord_h_1833384926(TEXT("/Script/MSC_Record"),
		Z_CompiledInDeferFile_FID_Users_Michel_Documents_Unreal_Projects_AM_VR_Plugins_MSC_Record_Source_MSC_Record_Public_BaseRecord_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Michel_Documents_Unreal_Projects_AM_VR_Plugins_MSC_Record_Source_MSC_Record_Public_BaseRecord_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Users_Michel_Documents_Unreal_Projects_AM_VR_Plugins_MSC_Record_Source_MSC_Record_Public_BaseRecord_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Michel_Documents_Unreal_Projects_AM_VR_Plugins_MSC_Record_Source_MSC_Record_Public_BaseRecord_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_Users_Michel_Documents_Unreal_Projects_AM_VR_Plugins_MSC_Record_Source_MSC_Record_Public_BaseRecord_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Michel_Documents_Unreal_Projects_AM_VR_Plugins_MSC_Record_Source_MSC_Record_Public_BaseRecord_h_Statics::EnumInfo));
