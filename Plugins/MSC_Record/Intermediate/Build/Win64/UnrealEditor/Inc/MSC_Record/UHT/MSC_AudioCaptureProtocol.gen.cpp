...
// End Cross Module References
	...
	UMSC_AudioCaptureProtocol::UMSC_AudioCaptureProtocol(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UMSC_AudioCaptureProtocol);
	UMSC_AudioCaptureProtocol::~UMSC_AudioCaptureProtocol() {}
	struct Z_CompiledInDeferFile_FID_Users_Michel_Documents_Unreal_Projects_AM_VR_Plugins_MSC_Record_Source_MSC_Record_Public_MSC_AudioCaptureProtocol_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Michel_Documents_Unreal_Projects_AM_VR_Plugins_MSC_Record_Source_MSC_Record_Public_MSC_AudioCaptureProtocol_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMSC_AudioCaptureProtocol, UMSC_AudioCaptureProtocol::StaticClass, TEXT("UMSC_AudioCaptureProtocol"), &Z_Registration_Info_UClass_UMSC_AudioCaptureProtocol, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMSC_AudioCaptureProtocol), 667563640U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Michel_Documents_Unreal_Projects_AM_VR_Plugins_MSC_Record_Source_MSC_Record_Public_MSC_AudioCaptureProtocol_h_3467972141(TEXT("/Script/MSC_Record"),
		Z_CompiledInDeferFile_FID_Users_Michel_Documents_Unreal_Projects_AM_VR_Plugins_MSC_Record_Source_MSC_Record_Public_MSC_AudioCaptureProtocol_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Michel_Documents_Unreal_Projects_AM_VR_Plugins_MSC_Record_Source_MSC_Record_Public_MSC_AudioCaptureProtocol_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
